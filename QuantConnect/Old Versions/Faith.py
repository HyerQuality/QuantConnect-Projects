...
class BasicTemplateAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        self.SetCash(61053.68)          #Set Strategy Cash
...
#OnData        
    def OnData(self, data):
        ...
        if self.IsWarmingUp or (not self.IsMarketOpen("SPY")): return
...
#TVIX
    def TvixFunc(self):
        ...
        self.Log("TVIX Function Has Fired.  || Relevant Metrics: EMADIff: {0}, TVIX Trigger: {1}, TVIX RSI: {2}".format(
            round(self.EMADiff.Current.Value,3), self.trigger, round(self.vixRsi.Current.Value,3)))
