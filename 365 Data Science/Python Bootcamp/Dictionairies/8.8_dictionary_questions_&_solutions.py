...
#    if user_input.lower().title() == 'United States':
#        break
#
#    user_input = input('Sorry, that isn\'t a valid option. Please enter a country: ')
#
#user_input = user_input.lower().title()
#if user_input in capitals:
#    print (f'The capital of {user_input} is {capitals[user_input]}.')
#else:
#    print ('I\'m sorry this country isn\'t in my database')
...
#        Prices[company] = dict(zip(key_names,prices[i]))
#print (Prices)
...
#
#for letter in keys:
#    Rand_Dict[letter] = random.randint(0, 100)
#
#print (Rand_Dict)
#
#x,y = zip(*Rand_Dict.items())
#plt.bar(x, y)
#
#d = dict()
#
